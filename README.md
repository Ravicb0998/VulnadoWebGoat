...
2. 
3. `git clone git://github.com/ScaleSec/vulnado`
4. `cd vulnado`
5. `docker-compose up`
6. Open a browser and navigate to the client to make sure it's working: [http://localhost:1337](http://localhost:1337)
7. Then back in your terminal verify you have connection to your API server: `nc -vz localhost 8080`
